...
const fsEmailGet = async e => { try { const s = await getDoc(doc(db, "emailIndex", emailKey(e))); return s.exists() ? s.data() : null; } catch { return null; } };
const fsEmailSet = async (e, uid, displayName) => { try { await setDoc(doc(db, "emailIndex", emailKey(e)), { uid, displayName }, { merge: true }); return true; } catch { return false; } };
